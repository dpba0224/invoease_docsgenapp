package com.springbootapp.invoease_api.Security;
...
public class ClerkJwksProvider {
    ...
    public PublicKey getJwks(String kid) throws Exception {
    ...
    private void refreshKeys() throws Exception {
        ...
        JsonNode jwsk = objectMapper.readTree(new URL(jwksUrl));
    ...
    private PublicKey createPublicKey(String modulus, String exponent) throws Exception {
        ...
        RSAPublicKeySpec specification = new RSAPublicKeySpec(modulusBigInteger, exponentBigInteger);
