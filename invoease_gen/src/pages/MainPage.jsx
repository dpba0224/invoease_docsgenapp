...
const MainPage = () => {
  ...
  const handleTemplateClick = (id) => {
    ...
    if(hasInvalidItem){
      toast.error("Please enter the quantity and amount for all items.")
      return;
    }
      ...
      <div className="container">
        ...
        <div className="bg-white border rounded shadow-sm p-3 mb-4">
          <div className="d-flex align-items-center">
            {/* If isEditingTitle is true, display textbox. Otherwise, display the button along with the cancel icon */}
            {isEditingTitle ? 
              (
                <input type="text" 
