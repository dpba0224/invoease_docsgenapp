...
const Template5 = ({ data }) => {
    ...
    return (
        <div className="template5 border rounded mx-auto my-4 p-4">
            {/* Header */}
            <div className="d-flex flex-column flex-md-row justify-content-between align-items-start mb-4">
                <div className="w-50">
                    ...
                    <h4 className="template5-company-name">{data.companyName}</h4>
                    <p className="mb-1">{data.companyAddress}</p>
                    <p className="mb-0">{data.companyPhone}</p>
                </div>
                <div className="text-md-end w-50">
                    <h5 className="template5-title template5-primary-color">Invoice</h5>
            ...
            <div className="mb-4 w-50">
                <h6 className="fw-bold template5-primary-color">Billed to</h6>
            ...
            <div className="table-responsive mb-4">
                <table className="table table-bordered mb-0">
                    <thead className="template5-table-head text-white">
                    <tr>
                        <th className="p-3 template5-table-head">Item #/Item description</th>
                        <th className="p-3 text-center template5-table-head">Quantity</th>
                        <th className="p-3 text-center template5-table-head">Rate</th>
                        <th className="p-3 text-end template5-table-head">Amount</th>
                    </tr>
                    </thead>
                    <tbody>
                ...
                <div style={{ width: '100%', maxWidth: '400px' }}>
                    <table className="table table-bordered mb-0">
                        ...
                        <tr>
                            ...
                            <td className="text-end">{data.currencySymbol}{subtotal}</td>
                        </tr>
                        <tr>
                            <td><strong>Tax ({data.tax}%)</strong></td>
                            <td className="text-end">{data.currencySymbol}{taxAmount}</td>
                        </tr>
                        <tr>
                            <td className="fw-bold template5-table-head"><strong>Total Due Amount</strong></td>
                            <td className="text-end fw-bold template5-table-head">{data.currencySymbol}{total}</td>
                        </tr>
                        </tbody>
                    </table>
                </div>
            ...
            {(data.accountName || data.accountNumber || data.accountIfscCode) && (
                <div className="mt-4">
                    <h6 className="mb-2 template5-primary-color fw-semibold">Bank Account Details</h6>
